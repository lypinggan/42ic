...
(function () {
	...
	WMDEditor.defaults = { // {{{
		...
		// entering links.
		imageDialogText: "<p style='margin-top: 0px'><b>请输入图片的网络地址或上传图片.</b></p><p>输入图片地址后您还可以输入图片的标题，这样鼠标放在图片上就会有相应的提示信息。</p><p>案例:<br />http://img.42ic.com/logo.png</p>",
		linkDialogText: "<p style='margin-top: 0px'><b>请输入网络地址.</b></p><p>输入网络地址后还可以输入链接内容或标题，给超链接命名.</p><p>案例:<br />http://www.42ic.com/</p>",
		...
		prompt: function (text, defaultInputText, makeLinkMarkdown, promptType) {
			...
			var createDialog = function () {
				...
				form.appendChild(label);
					...
					label.appendChild(document.createTextNode(promptType+" URL地址:"));
				...
				form.appendChild(label);
					...
					label.appendChild(document.createTextNode(promptType+" 标题 (Hover Text):"));
				...
				if (promptType=='link') {
					...
					form.appendChild(label);
						...
						label.appendChild(document.createTextNode(" 在新窗口打开此链接"));
				}
